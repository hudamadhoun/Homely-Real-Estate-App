    ...
    return Column(
      children: [
        Container(
          child: CarouselSlider.builder(
            ...
            itemBuilder: (BuildContext context, int index, int realIndex) {
              final images = widget.productsoffice.images[index];
              return Container(
            ...
            itemCount: widget.productsoffice.images.length,
          ),
        ),
        SizedBox(
          height: 15,
        ...
        AnimatedSmoothIndicator(
            ...
            count: widget.productsoffice.images.length),
          ...
          child: Column(
            children: [
              ...
              Container(
                alignment: Alignment.centerRight,
                child: Text(
                  widget.productsoffice.description,
                  style: TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.w200,
                    fontSize: 15,
