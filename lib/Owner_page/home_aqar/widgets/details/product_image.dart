      ...
      child: Column(
        children: [
          Container(
            child: CarouselSlider.builder(
              ...
              itemBuilder: (BuildContext context, int index, int realIndex) {
                final images = widget.producthome.images[index];
                return Container(
              ...
              itemCount: widget.producthome.images.length,
            ),
          ),
          SizedBox(
            height: 15,
          ...
          AnimatedSmoothIndicator(
              ...
              count: widget.producthome.images.length),
          Padding(
            ...
            child: Column(
              children: [
                ...
                Container(
                  alignment: Alignment.centerRight,
                  child: Text(
                    widget.producthome.description,
                    style: TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.w200,
                      fontSize: 15,
