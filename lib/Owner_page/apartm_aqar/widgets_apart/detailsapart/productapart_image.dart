    ...
    return Column(
      children: [
        Container(
          child: CarouselSlider.builder(
            ...
            itemBuilder: (BuildContext context, int index, int realIndex) {
              final images = widget.productsapart.images[index];
              return Container(
            ...
            itemCount: widget.productsapart.images.length,
          ),
        ),
        SizedBox(
          height: 15,
        ...
        AnimatedSmoothIndicator(
            ...
            count: widget.productsapart.images.length),
          ...
          child: Column(
            children: [
              ...
              Container(
                alignment: Alignment.centerRight,
                child: Text(
                  widget.productsapart.description,
                  style: TextStyle(
                    color: Colors.black,
                    fontWeight: FontWeight.w200,
                    fontSize: 15,
